...
/*   Updated: 2026/01/31 09:24:19 by julauren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../so_long.h"

static void	ft_init_map_1(t_data *data)
{
...
static void	ft_init_map_2(t_data *data)
{
...
void	ft_init_map(t_data *data, char **map)
{
	...
	data->width = 32 * data->x;
	data->height = 32 * data->y;
}
