...
/*   Updated: 2026/01/31 13:06:48 by julauren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_display(char **map)
{
	...
	mlx_put_image_to_window(p.mlx, p.win, a.border_top_1, 32, 0);
	mlx_put_image_to_window(p.mlx, p.win, a.border_top_2, 64, 0);
	mlx_put_image_to_window(p.mlx, p.win, a.corner_2, d.width - 32, 0);
	mlx_put_image_to_window(p.mlx, p.win, a.border_right_1, d.width - 32, 32);
	mlx_put_image_to_window(p.mlx, p.win, a.border_right_2, d.width - 32, 64);
	mlx_put_image_to_window(p.mlx, p.win, a.corner_3, d.width - 32, d.height - 32);
	mlx_put_image_to_window(p.mlx, p.win, a.border_botttom_1, d.width - 96, d.height - 32);
	mlx_put_image_to_window(p.mlx, p.win, a.border_botttom_2, d.width - 64, d.height - 32);
	mlx_put_image_to_window(p.mlx, p.win, a.corner_4, 0, d.height - 32);
	mlx_put_image_to_window(p.mlx, p.win, a.border_left_1, 0, d.height - 96);
	mlx_put_image_to_window(p.mlx, p.win, a.border_left_2, 0, d.height - 64);
